...
export const URL_USER_ADMIN = 'http://localhost:8080/user/admin';

export const URL_USER_ID = 'http://localhost:8080/user/{userId}';

export const URL_USER_ALL = 'http://localhost:8080/user/all';

export const URL_USER_ALL_ADMIN = 'http://localhost:8080/user/admins';

export const URL_USER_ALL_COMUM = 'http://localhost:8080/user/users';
...
export const URL_CART_PRODUCT_DELETE = 'http://localhost:8080/cart/product/{productId}';
...
export const URL_CORREIOS = 'http://localhost:8080/correios';